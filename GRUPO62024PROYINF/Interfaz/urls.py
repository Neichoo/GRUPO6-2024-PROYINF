...
urlpatterns = [
    ...
    path('EditarBoletinBorrador/', views.BoletinBorrador_listado, name='lista_borradores'),
    path('EditarBoletinBorrador/<int:id_boletin>/', views.EditarBoletinBorrador, name='editar_borrador'),
